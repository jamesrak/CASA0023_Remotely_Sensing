...
\hypersetup{
  pdftitle={Synthetic Aperture Radar (SAR)},
...
\title{Synthetic Aperture Radar (SAR)}
...
\chapter{Sensor Summary}\label{sensor-summary}}
...
\begin{quote}
days to weeks: differential interferometry, soil moisture, agricultural
areas
\end{quote}

\begin{quote}
months to year: tropical, temperate and boreal forests, differential
interf
\end{quote}
...
\hypertarget{sar-applications}{%
\chapter{SAR Applications}\label{sar-applications}}

\begin{figure}

{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{images/4-21_AustrailianSAR_BlogPic1.jpeg}
